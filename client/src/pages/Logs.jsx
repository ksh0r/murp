    ...
    return (
        <div className="log-header">
            ...
            <div className="log-entry">
                <input type="text" onKeyDown={handleKeyDown} className="log-input" placeholder="Enter your log" value={newMessage} onChange={(e) => setNewMessage(e.target.value)}/>
                <button className="log-button" ref={buttonRef} onClick={handleAddLog}>Log</button>
            </div>
